...
// TriggerDatapathRegen triggers policy updates for every daemon's endpoint.
// The difference with TriggerPolicyUpdates is that this rewrites datapath.
// This is only called after agent configuration changes for now.
